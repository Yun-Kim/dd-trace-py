...
def test_start_wrong_arg():
    ...
    with pytest.raises(ValueError, match="the heap sample size must be in range \\[1; 4294967295\\]"):
...
@pytest.mark.benchmark(
    group="memory-capture", min_time=1,
    disable_gc=True,
)
@pytest.mark.parametrize(
    "heap_sample_size",
    (0, 512 * 1024, 1024 * 1024, 2048 * 1024, 4096 * 1024)
)
